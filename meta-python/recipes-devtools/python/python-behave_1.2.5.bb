...
RDEPENDS_${PN} += "python-difflib python-setuptools python-pkgutil python-misc python-xml python-importlib python-enum34 python-parse python-parse-type python-six"
